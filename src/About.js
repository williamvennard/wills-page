  ...
  return (
    <div className="container-fluid about-container">
      <h1>About Me</h1>
	    ...
	    <p>
	    	I am currently a Front-End Web Developer at GradentOne, where for the past few years, I've been 
	      ...
	      test data acquisition and archiving, as well as advanced data analytics.
	    </p>

	    <p>
	    	Alii dicant hendrerit mei an, per iudicabit scriptorem ne. Aeque conceptam deterruisset in qui. 
	    	Minim sadipscing appellantur in his, idque dicunt ponderum ad usu. Te vocent aliquip alterum sea, 
	    	ex delectus phaedrum ius. Congue placerat repudiare et sit. Blandit mentitum atomorum per cu. Ad 
	    	pro noluisse dissentiunt, ius error tempor ut.
	    </p>
